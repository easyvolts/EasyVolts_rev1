...
#define USB_MAX_EP_NUMBER	    4//2   //Set this number to match the maximum endpoint number used in the descriptors for this firmware project
...
//added for second CDC
#define CDC_COMM_INTF_ID2        0x02
#define CDC_COMM_EP2              3
#define CDC_COMM_IN_EP_SIZE2      10

#define CDC_DATA_INTF_ID2        0x03
#define CDC_DATA_EP2             4
#define CDC_DATA_OUT_EP_SIZE2    64
#define CDC_DATA_IN_EP_SIZE2     64
