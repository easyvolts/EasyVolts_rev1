...
{    
    ...
    USB_DESCRIPTOR_DEVICE,  // DEVICE descriptor type
    0x0200,                 // USB Spec Release Number in BCD format
    0xEF, 					// Class Code (miscellaneouse)
    0x02,                   // Subclass code (common)
    0x01,                   // Protocol code (IAD)
    USB_EP0_BUFF_SIZE,      // Max packet size for EP0, see usbcfg.h
    0x04D8,                 // Vendor ID
    0x000B,                 // Product ID: 2 * CDC RS-232 Emulation Demo
...
const uint8_t configDescriptor1[]={
	...
	8,                      // Size of this descriptor in byte
	USB_DESCRIPTOR__IAD, 	// Interface assocication descriptor type
...
{'C','D','C','_','P','o','w','e','r','+','C','D','C',
 '_','U','A','R','T','/','R','S','4','8','5'}
};

//Product string descriptor 1
const struct{uint8_t bLength;uint8_t bDscType;uint16_t string[25];}sd003={
...
const struct{uint8_t bLength;uint8_t bDscType;uint16_t string[24];}sd004={
sizeof(sd004),USB_DESCRIPTOR_STRING,
{'C','D','C','<','-','>','U','A','R','T','/',
 'R','S','4','8','5',' ','a','d','a','p','t','e','r'}
};
...
{
    (const uint8_t *const)&sd000, //language string
    (const uint8_t *const)&sd001, //manufactorer string
    (const uint8_t *const)&sd002, //device string
    (const uint8_t *const)&sd003, //product1 string
    (const uint8_t *const)&sd004, //product2 string
    //(const uint8_t *const)&sd005  //uncomment if implementing a serial number string descriptor named sd005
};
